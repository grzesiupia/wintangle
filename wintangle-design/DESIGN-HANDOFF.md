# 252e8140-1e9a-4721-8fa0-1aa998718a67 implementation handoff

This archive is the source of truth for turning the design into production code. Start from `wintangle-app.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
## Source map
- Primary entry: `wintangle-app.html`
...
- A single self-contained `wintangle-app.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `wintangle-app.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
- `brand-spec.md`
- `functionality-for-designer.md`
- `sketch-tile-6.bmp`
- `sketch-tile-6.png`

## Coding checklist for AI tools
1. Inspect `wintangle-app.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
